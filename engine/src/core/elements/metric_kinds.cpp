...
nlohmann::json condition_schema () {
    return {
        { "type", "object" },
        { "properties",
        { { "field", { { "type", "string" }, { "enum", { "status", "header", "jsonpath", "latency", "size" } } } },
        { "header", { { "type", "string" } } }, { "jsonpath", { { "type", "string" } } },
        { "operator",
...
ElementKind make_metric_record_kind () {
    ...
    kind.config_schema = {
        ...
        { "type", { { "type", "string" }, { "enum", { "trend", "counter", "rate" } } } },
        { "source",
        { { "type", "object" },
        { "properties",
        { { "jsonpath", { { "type", "string" } } }, { "header", { { "type", "string" } } },
        { "latency", { { "type", "boolean" } } }, { "status", { { "type", "boolean" } } },
        { "size", { { "type", "boolean" } } }, { "condition", condition_schema () } } },
        { "additionalProperties", false } } } } },
