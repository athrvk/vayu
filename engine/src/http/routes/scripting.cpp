...
nlohmann::json get_script_completions() {
    ...
    // pm object
    // ========================================
    completions.push_back({{"label", "pm"},
                           {"kind", KIND_VARIABLE},
                           {"insertText", "pm"},
                           {"detail", "Postman API object"},
                           {"documentation",
    ...
    // ========================================
    completions.push_back({{"label", "pm.response"},
                           {"kind", KIND_VARIABLE},
    ...
    completions.push_back({{"label", "pm.response.status"},
                           {"kind", KIND_FIELD},
    ...
    completions.push_back({{"label", "pm.response.responseTime"},
                           ...
                           {"detail", "number"},
                           {"documentation", "The total response time in milliseconds."},
                           {"sortText", "1_pm_response_time"}});

    completions.push_back({{"label", "pm.response.headers"},
                           {"kind", KIND_FIELD},
    ...
    completions.push_back({{"label", "pm.response.json"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "pm.response.json()"},
                           {"detail", "pm.response.json(): any"},
                           {"documentation",
                            "Parse and return the response body as JSON.\n\nExample:\nconst data = "
                            "pm.response.json();\npm.expect(data.id).to.exist;"},
                           {"sortText", "1_pm_response_json"}});

    completions.push_back({{"label", "pm.response.text"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "pm.response.text()"},
                           {"detail", "pm.response.text(): string"},
    ...
    // ========================================
    completions.push_back(
        {{"label", "pm.response.to.have.status"},
         {"kind", KIND_FUNCTION},
         {"insertText", "pm.response.to.have.status(${1:200})"},
         {"insertTextRules", INSERT_AS_SNIPPET},
    ...
    completions.push_back({{"label", "pm.response.to.have.header"},
                           {"kind", KIND_FUNCTION},
    ...
    completions.push_back({{"label", "pm.response.to.have.jsonBody"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "pm.response.to.have.jsonBody()"},
    ...
    completions.push_back({{"label", "pm.request.url"},
                           {"kind", KIND_FIELD},
                           {"insertText", "pm.request.url"},
                           {"detail", "string"},
                           {"documentation", "The full request URL."},
                           {"sortText", "1_pm_request_url"}});

    completions.push_back({{"label", "pm.request.method"},
                           {"kind", KIND_FIELD},
    ...
    completions.push_back({{"label", "pm.request.headers"},
                           ...
                           {"detail", "object"},
                           {"documentation", "Request headers as key-value pairs."},
                           {"sortText", "1_pm_request_headers"}});

    completions.push_back({{"label", "pm.request.body"},
                           {"kind", KIND_FIELD},
    ...
    completions.push_back({{"label", "pm.environment.get"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "pm.environment.get(\"${1:variable}\")"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
    ...
    // ========================================
    completions.push_back({{"label", "pm.variables"},
                           {"kind", KIND_VARIABLE},
    ...
    completions.push_back(
        {{"label", "pm.variables.get"},
         {"kind", KIND_FUNCTION},
         {"insertText", "pm.variables.get(\"${1:variable}\")"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", "pm.variables.get(name: string): any"},
         {"documentation",
          "Get a variable value. Searches environment, collection, and global scopes."},
         {"sortText", "1_pm_variables_get"}});

    completions.push_back({{"label", "pm.variables.set"},
                           {"kind", KIND_FUNCTION},
    ...
    completions.push_back({{"label", "console.info"},
                           {"kind", KIND_FUNCTION},
    ...
    completions.push_back({{"label", "console.warn"},
                           {"kind", KIND_FUNCTION},
    ...
    completions.push_back({{"label", "console.error"},
                           {"kind", KIND_FUNCTION},
    ...
    completions.push_back({{"label", "to.be.true"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.true"},
                           {"detail", ".to.be.true"},
                           {"documentation", "Assert the value is true."},
                           {"sortText", "2_to_be_true"},
                           {"filterText", ".to.be.true"}});

    completions.push_back({{"label", "to.be.false"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.false"},
                           {"detail", ".to.be.false"},
                           {"documentation", "Assert the value is false."},
                           {"sortText", "2_to_be_false"},
                           {"filterText", ".to.be.false"}});

    completions.push_back({{"label", "to.be.null"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.null"},
                           {"detail", ".to.be.null"},
                           {"documentation", "Assert the value is null."},
                           {"sortText", "2_to_be_null"},
                           {"filterText", ".to.be.null"}});

    completions.push_back({{"label", "to.be.undefined"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.undefined"},
                           {"detail", ".to.be.undefined"},
                           {"documentation", "Assert the value is undefined."},
                           {"sortText", "2_to_be_undefined"},
                           {"filterText", ".to.be.undefined"}});

    completions.push_back({{"label", "to.be.ok"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.ok"},
                           {"detail", ".to.be.ok"},
    ...
    completions.push_back({{"label", "to.exist"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.exist"},
                           {"detail", ".to.exist"},
    ...
    completions.push_back({{"label", "to.be.above"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.be.above(${1:n})"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.be.above(n: number)"},
                           {"documentation",
                            "Assert the number is greater than "
                            "n.\n\nExample:\npm.expect(responseTime).to.be.above(0);"},
                           {"sortText", "2_to_be_above"},
                           {"filterText", ".to.be.above"}});

    completions.push_back(
        {{"label", "to.be.below"},
         {"kind", KIND_FUNCTION},
         {"insertText", "to.be.below(${1:n})"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", ".to.be.below(n: number)"},
         {"documentation",
          "Assert the number is less than "
          "n.\n\nExample:\npm.expect(pm.response.responseTime).to.be.below(1000);"},
         {"sortText", "2_to_be_below"},
         {"filterText", ".to.be.below"}});

    completions.push_back({{"label", "to.be.at.least"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.be.at.least(${1:n})"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.be.at.least(n: number)"},
                           {"documentation", "Assert the number is greater than or equal to n."},
                           {"sortText", "2_to_be_at_least"},
                           {"filterText", ".to.be.at.least"}});

    completions.push_back({{"label", "to.be.at.most"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.be.at.most(${1:n})"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.be.at.most(n: number)"},
                           {"documentation", "Assert the number is less than or equal to n."},
                           {"sortText", "2_to_be_at_most"},
                           {"filterText", ".to.be.at.most"}});

    completions.push_back(
        {{"label", "to.have.property"},
         {"kind", KIND_FUNCTION},
         {"insertText", "to.have.property(\"${1:name}\")"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", ".to.have.property(name: string)"},
         {"documentation",
          "Assert the object has a property.\n\nExample:\npm.expect(data).to.have.property('id');"},
         {"sortText", "2_to_have_property"},
         {"filterText", ".to.have.property"}});

    completions.push_back(
        {{"label", "to.have.length"},
         {"kind", KIND_FUNCTION},
         {"insertText", "to.have.length(${1:n})"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", ".to.have.length(n: number)"},
         {"documentation",
          "Assert array or string length.\n\nExample:\npm.expect(items).to.have.length(5);"},
         {"sortText", "2_to_have_length"},
         {"filterText", ".to.have.length"}});

    completions.push_back(
        {{"label", "to.have.lengthOf"},
         {"kind", KIND_FUNCTION},
         {"insertText", "to.have.lengthOf(${1:n})"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", ".to.have.lengthOf(n: number)"},
         {"documentation", "Assert array or string length (alias for .to.have.length)."},
         {"sortText", "2_to_have_lengthOf"},
         {"filterText", ".to.have.lengthOf"}});

    completions.push_back({{"label", "to.include"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.include(${1:value})"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.include(value: any)"},
                           {"documentation",
                            "Assert array includes value or string contains "
                            "substring.\n\nExample:\npm.expect(tags).to.include('featured');"},
                           {"sortText", "2_to_include"},
                           {"filterText", ".to.include"}});

    completions.push_back(
        {{"label", "to.contain"},
         {"kind", KIND_FUNCTION},
         {"insertText", "to.contain(${1:value})"},
         {"insertTextRules", INSERT_AS_SNIPPET},
         {"detail", ".to.contain(value: any)"},
         {"documentation", "Assert array includes value (alias for .to.include)."},
         {"sortText", "2_to_contain"},
         {"filterText", ".to.contain"}});

    completions.push_back({{"label", "to.be.a"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.be.a(\"${1:type}\")"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.be.a(type: string)"},
                           {"documentation",
    ...
    completions.push_back({{"label", "to.be.an"},
                           {"kind", KIND_FUNCTION},
                           {"insertText", "to.be.an(\"${1:type}\")"},
                           {"insertTextRules", INSERT_AS_SNIPPET},
                           {"detail", ".to.be.an(type: string)"},
                           {"documentation",
    ...
    completions.push_back({{"label", "to.be.empty"},
                           {"kind", KIND_FIELD},
                           {"insertText", "to.be.empty"},
                           {"detail", ".to.be.empty"},
                           {"documentation", "Assert the array/string/object is empty."},
                           {"sortText", "2_to_be_empty"},
                           {"filterText", ".to.be.empty"}});
    ...
    // ========================================
    completions.push_back({{"label", "Test: Status code"},
                           {"kind", KIND_SNIPPET},
                           {"insertText",
    ...
    completions.push_back({{"label", "Test: Response time"},
                           {"kind", KIND_SNIPPET},
                           {"insertText",
    ...
    completions.push_back(
        {{"label", "Set environment variable"},
         ...
         {"insertText",
          ...
          "pm.response.json();\npm.environment.set(\"${1:token}\", json.${2:token});"},
         {"insertTextRules", INSERT_AS_SNIPPET},
