...
TEST_F (ConfigRouteTest, AdvancedFlagsExactlyTheRecordedInternals) {
    ...
    // The one-time script-to-elements fold's own marker (#1513,
    // `scriptsFoldedIntoElements`) retired with #1514: `PRAGMA user_version`
    // is the migration marker now, not a config entry.
