            ...
            {dnsMs !== undefined && (
                <div className={`bg-blue-50 dark:bg-blue-950/30 ${padding} rounded text-center`}>
                    ...
                    <p className={`${textSize} font-bold text-blue-700 dark:text-blue-300`}>
                        {dnsMs.toFixed(1)}<span className="text-xs font-normal">ms</span>
                    </p>
                </div>
            )}
            {connectMs !== undefined && (
                <div className={`bg-purple-50 dark:bg-purple-950/30 ${padding} rounded text-center`}>
                    ...
                    <p className={`${textSize} font-bold text-purple-700 dark:text-purple-300`}>
                        {connectMs.toFixed(1)}<span className="text-xs font-normal">ms</span>
                    </p>
                </div>
            )}
            {tlsMs !== undefined && (
                <div className={`bg-indigo-50 dark:bg-indigo-950/30 ${padding} rounded text-center`}>
                    ...
                    <p className={`${textSize} font-bold text-indigo-700 dark:text-indigo-300`}>
                        {tlsMs.toFixed(1)}<span className="text-xs font-normal">ms</span>
                    </p>
                </div>
            )}
            {firstByteMs !== undefined && (
                <div className={`bg-green-50 dark:bg-green-950/30 ${padding} rounded text-center`}>
                    ...
                    <p className={`${textSize} font-bold text-green-700 dark:text-green-300`}>
                        {firstByteMs.toFixed(1)}<span className="text-xs font-normal">ms</span>
                    </p>
                </div>
            )}
            {downloadMs !== undefined && (
                <div className={`bg-yellow-50 dark:bg-yellow-950/30 ${padding} rounded text-center`}>
                    ...
                    <p className={`${textSize} font-bold text-yellow-700 dark:text-yellow-300`}>
                        {downloadMs.toFixed(1)}<span className="text-xs font-normal">ms</span>
                    </p>
                </div>
            )}
        </div>
