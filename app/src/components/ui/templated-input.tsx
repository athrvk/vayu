...
export function TemplatedInput({
    ...
    const [editingVariable, setEditingVariable] = useState<{ name: string; value: string; scope: VariableScope } | null>(null);
    ...
    const getScopeBadge = (scope: VariableScope) => {
        switch (scope) {
            case "global":
                return (
                    <Badge variant="outline" className="h-5 px-1.5 text-[10px] font-medium bg-muted">
                        G
                    </Badge>
                );
            case "collection":
                return (
                    <Badge variant="outline" className="h-5 px-1.5 text-[10px] font-medium bg-blue-50 text-blue-700 border-blue-200">
                        C
                    </Badge>
                );
            case "environment":
                return (
                    <Badge variant="outline" className="h-5 px-1.5 text-[10px] font-medium bg-green-50 text-green-700 border-green-200">
                        E
                    </Badge>
                );
        }
