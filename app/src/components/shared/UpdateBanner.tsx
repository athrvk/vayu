...
function UpdateBanner() {
	...
	return (
		<div className="enter-fade flex flex-col gap-1.5 border-b border-border bg-secondary/60 px-4 py-2 text-sm">
			...
			{downloading ? (
				<Progress value={downloadProgress} label={`Downloading Vayu ${update.version}`} />
			) : null}
		</div>
	);
}
