...
export default function VariableToken({
    ...
    const getScopeBadge = () => {
        const config: Record<VariableScope, { label: string; className: string }> = {
            global: { label: "Global", className: "bg-green-100 text-green-700 dark:bg-green-950 dark:text-green-300" },
            collection: { label: "Collection", className: "bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-300" },
            environment: { label: "Environment", className: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300" },
        };
                ...
                <div className="space-y-3">
                    ...
                    {resolved ? (
                        ...
                        <div className="text-sm text-destructive">
                            Variable not defined. Define it in Globals, an Environment, or Collection variables.
                        </div>
                    )}
                </div>
            </PopoverContent>
