...
import { Monitor, Sun, Moon, Palette, CheckCircle2, Circle, Cloud, Waves, Trees, Sunset, Sparkles, Heart } from "lucide-react";
...
export default function UISettingsPanel() {
    ...
    const themeOptions: { value: ThemeSource; label: string; icon: typeof Sun; description: string }[] = [
        {
            value: "system",
            label: "System",
            icon: Monitor,
    ...
    const colorSchemeOptions: { value: ColorScheme; label: string; icon: typeof Cloud; description: string; color: string }[] = [
        {
            value: "sky",
            label: "Sky",
            icon: Cloud,
                ...
                <div className="grid gap-6 max-w-3xl">
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>
                                Choose your preferred accent color. This affects buttons, highlights, and primary UI elements.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {isLoading ? (
