...
const appSettings = [
	{
		...
		label: "Theme Mode",
		searchText: "The app's light or dark palette.",
		keywords: ["dark mode"],
	},
	{
		...
		label: "Orphan",
		searchText: "Belongs to a panel that is not registered.",
	},
];
			...
			appSettings: [
				{
					...
					searchText: "Mentions zebra in passing.",
				},
				{
					anchor: "by-keyword",
					panel: "appearance" as const,
					label: "Another thing",
					searchText: "No mention here.",
					keywords: ["zebra"],
				},
				{
					anchor: "by-label",
					panel: "appearance" as const,
					label: "Zebra",
					searchText: "No mention here either.",
				},
			],
			engineEntries: [],
			engineCategories,
